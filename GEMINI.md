...
## 0. Mandatory Rules & Guidelines
- **Project Rules**: All development must strictly follow [PROJECT_RULES.md](PROJECT_RULES.md).
- **AI Execution**: AI agents must strictly follow [AI_GUIDELINES.md](AI_GUIDELINES.md).

## 1. Library-First Research Mandate
...
## 2. Atomic Trilogy Architecture (Modular Sidecars)
...
## 3. The Indicator Lake (Anti-Error Loop)
...
## 4. Institutional Intelligence Standards
...
- **Guardrails**: Run `python tools/performance_guard.py` before every commit.
