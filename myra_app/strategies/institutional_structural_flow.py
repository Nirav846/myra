...
class Strategy:
    ...
    def run(self, df: pd.DataFrame, funda: dict) -> dict:
        ...
        def get_grade(score):
            if score >= 3.5: return "A+" # Strong Reversal + Multi-Confluence
            if score >= 3.0: return "A"  # High Quality Setup
            if score >= 2.5: return "B+" # Good Confluence
            if score >= 2.0: return "B"  # Valid Setup
