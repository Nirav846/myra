...
class Strategy:
    ...
    def run(self, df: pd.DataFrame, funda: dict) -> dict:
        ...
        try:
            ...
            is_dip_accumulation = (latest_del > (latest_avg * 1.8) and latest_del > 40 and ltp < prev_close and ltp > prev_close * 0.95)
            ...
            if is_green_spike or is_red_absorption or is_dip_accumulation:
                return {
                    ...
                    "metrics": {
                        "LTP": round(ltp, 2),
                        "Spike": "GREEN SPIKE" if is_green_spike else "BOTTOM ABSORPTION" if is_red_absorption else "DIP ACCUMULATION",
