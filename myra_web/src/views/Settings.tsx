      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8 text-sm pb-16">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            <label className="block text-[#888] text-xs uppercase tracking-wider font-mono">
              Environment Theme
            </label>
            <div className="grid grid-cols-2 gap-3">
              {[
                {
                  id: "myra-dark" as Theme,
                  label: "Myra Default",
                  icon: <Monitor size={16} />,
                },
                {
                  id: "pitch-black" as Theme,
                  label: "OLED Black",
                  icon: <Moon size={16} />,
                },
              ].map((theme) => (
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded border text-sm font-mono transition-colors ${
                    settings.sidebarPosition === pos
                      ...
                      : "border-[#ffffff1a] bg-[#0e1117] hover:border-[#ffffff3a]"
                  }`}
                >
                  {pos}
                </button>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2 flex-wrap">
              {(["Hollow", "Filled", "Heikin-Ashi"] as CandlestickStyle[]).map(
                (r) => (
                  <button
                    key={r}
                    onClick={() => updateSettings({ candlestickStyle: r })}
                    className={`px-3 py-1.5 rounded border text-sm font-mono transition-colors ${
                      settings.candlestickStyle === r
                        ? "border-blue-500 bg-blue-500/10 text-blue-400"
                        : "border-[#ffffff1a] bg-[#0e1117] hover:border-[#ffffff3a]"
                    }`}
                  >
          ...
          <div className="space-y-3">
            <label
              ...
              className="flex items-center gap-3 p-3 bg-[#0e1117] border border-[#ffffff1a] rounded cursor-pointer hover:bg-[#ffffff05] transition-colors mt-2"
            >
              <input
                id="showGridLines"
                type="checkbox"
                ...
                onChange={(e) =>
                  updateSettings({ showGridLines: e.target.checked })
                }
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-[#888]">
                  Display horizontal and vertical grid markers on main charts
                </span>
              </div>
            </label>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2 flex-wrap">
              {(
                ["Off", "10s", "30s", "1min", "5min"] as AutoRefreshInterval[]
              ).map((r) => (
                <button
                  key={r}
                  onClick={() => updateSettings({ autoRefreshInterval: r })}
                  className={`px-3 py-1.5 rounded border text-sm font-mono transition-colors ${
                    settings.autoRefreshInterval === r
                      ? "border-blue-500 bg-blue-500/10 text-blue-400"
                      : "border-[#ffffff1a] bg-[#0e1117] hover:border-[#ffffff3a]"
                  }`}
                >
            ...
            <p className="text-xs text-[#888]">
              Background polling for live quotes/status. Paused when tab is
              hidden.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-[#888]">
                  Enable layout transitions, pulsing dots, and charting
                  animations.
                </span>
              </div>
            </label>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            <label
              htmlFor="enableSoundAlerts"
              className="flex items-center gap-3 p-3 bg-[#0e1117] border border-[#ffffff1a] rounded cursor-pointer hover:bg-[#ffffff05] transition-colors"
            >
              <input
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-[#888]">
                  Play a chime when scanners detect a new FVG or pattern
                </span>
              </div>
            </label>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-[#888]">
                  Show log panel, verbose errors, and query times
                </span>
              </div>
            </label>
            <label
              htmlFor="mockDataMode"
              className="flex items-center gap-3 p-3 bg-[#0e1117] border border-[#ffffff1a] rounded cursor-pointer hover:bg-[#ffffff05] transition-colors"
            >
              <input
                id="mockDataMode"
                ...
                onChange={(e) =>
                  updateSettings({ mockDataMode: e.target.checked })
                }
                className="w-4 h-4 rounded border-[#333] bg-[#0e1117] text-blue-500 focus:ring-blue-500/20"
              />
              <div className="flex flex-col">
                ...
                <span className="text-xs text-[#888]">
                  Globally force mock data structures (UI layout testing)
                </span>
              </div>
            </label>
          </div>
        ...
        <section className="space-y-4 md:col-span-2 mt-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-[#888]">
              Defines the URL where the React frontend will attempt to connect
              to your local Python/FastAPI backend (Librarian Bridge).
            </p>
          </div>
        </section>
      </div>
