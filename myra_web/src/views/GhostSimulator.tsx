      ...
      <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-[#0e1117] rounded-lg border border-[#ffffff0a] p-5 space-y-5">
          <div className="flex items-center gap-2 text-[#ccc] border-b border-[#ffffff1a] pb-2">
            <Settings2 size={16} />{" "}
            <h4 className="font-semibold">Entry Parameters</h4>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setParams({
                    ...params,
                    minDeliveryPct: Number(e.target.value),
                  })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setParams({
                    ...params,
                    minVolumeSpike: Number(e.target.value),
                  })
                }
            ...
            <label className="flex items-center gap-3 p-3 bg-[#1a1c24] border border-[#ffffff1a] rounded cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  setParams({ ...params, fvgConfirmation: e.target.checked })
                }
                className="accent-purple-500 w-4 h-4"
              />
              <span className="text-sm text-[#eee] font-medium">
                Require FVG Support Confirmation
              </span>
            </label>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center bg-[#1a1c24] p-3 rounded border border-[#ffffff0a]">
              ...
              <input
                ...
                onChange={(e) =>
                  setParams({ ...params, stopLossPct: Number(e.target.value) })
                }
        ...
        <div className="lg:col-span-2 bg-[#0e1117] rounded-lg border border-[#ffffff0a] p-6 flex flex-col justify-center">
          {!results && !running && (
            <div className="text-center text-[#555]">
              ...
              <p className="text-sm font-mono">
                Configure parameters and inject logic vector to generate
                backtest matrix.
              </p>
            </div>
          )}
          ...
          {running && (
            <div className="text-center text-[#888]">
              ...
              <p className="font-mono text-xs uppercase animate-pulse">
                Scanning Historical Arrays (2014-2024)...
              </p>
            </div>
          )}
            ...
            <div className="animation-fade-in space-y-6">
              <h4 className="text-lg font-semibold border-b border-[#ffffff1a] pb-2 flex items-center justify-between text-purple-400">
                ...
                <span className="text-xs bg-purple-500/20 text-purple-300 px-2 py-1 rounded font-mono">
                  AEON_CONFIDENCE: HIGH
                </span>
              </h4>

              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-[#1a1c24] p-4 rounded border border-[#ffffff1a]">
                  <div className="text-[#888] text-[10px] uppercase font-mono">
                    Win Rate
                  </div>
                  <div
                    className={`text-3xl font-bold mt-1 ${results.winRate > 50 ? "text-green-400" : "text-red-400"}`}
                  >
                    {results.winRate}%
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#ccc] mt-1">
                      This entry logic demonstrates a statistically significant
                      edge. High delivery percentage thresholds effectively
                      filter out 'fakeout' volume anomalies.
                    </p>
                  </div>
                </div>
              </div>
