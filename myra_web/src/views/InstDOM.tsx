      ...
      <div className="p-6 flex flex-col gap-6">
        ...
        <div className="flex flex-wrap gap-4 items-center bg-[#0e1117] p-3 rounded-lg border border-[#ffffff0a]">
          <div className="flex items-center gap-3">
            <label className="text-xs font-mono text-[#888] uppercase">
              Target Ticker
            </label>
            <input
              type="text"
          ...
          <div className="flex items-center gap-3 border-l border-[#ffffff1a] pl-4">
            ...
            >
              <option className="bg-[#1a1c24] text-[#fafafa]" value={7}>
                Last 7 Days
              </option>
          ...
          <div className="ml-auto flex items-center gap-3">
            {errorMsg && (
              <span className="text-[10px] text-red-400 font-mono px-2 py-1 bg-red-500/10 rounded border border-red-500/20">
                {errorMsg}
              </span>
            )}
            {isDemo && (
              <span className="text-[10px] text-yellow-500 font-mono px-2 py-1 bg-yellow-500/10 rounded border border-yellow-500/20 px-2">
                ⚠️ DEMO DATA
              </span>
            )}
            {isLoading && (
