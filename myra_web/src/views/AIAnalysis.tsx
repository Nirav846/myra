      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 bg-[#ffffff05] p-3 rounded border border-[#ffffff0a]">
          <div
            ...
            title="Select the metric to focus the AI analysis on (e.g. Institutional Flow, Technical Scan)."
          >
            <label className="text-[10px] text-[#888] uppercase font-semibold">
              Target
            </label>
            <select
              value={target}
              onChange={(e) => setTarget(e.target.value)}
              className="bg-[#0e1117] border border-[#ffffff1a] text-[#ccc] text-xs p-1.5 rounded font-mono focus:outline-none focus:border-blue-500 transition-colors"
            >
              <option className="bg-[#1a1c24] text-[#fafafa]" value="inst_flow">
                inst_flow
              </option>
              <option className="bg-[#1a1c24] text-[#fafafa]" value="tech_scan">
                tech_scan
              </option>
              <option
          ...
          <div
            className="flex flex-col gap-1"
            title="Set the recursion depth for historical data traversal."
          >
            <label className="text-[10px] text-[#888] uppercase font-semibold">
              Depth
            </label>
          ...
          <div
            className="flex flex-col gap-1"
            title="Choose the quantitative model architecture to execute."
          >
            <label className="text-[10px] text-[#888] uppercase font-semibold">
              Model
            </label>
            ...
            >
              <option
                className="bg-[#1a1c24] text-[#fafafa]"
                value="myra_quant_v2.2"
              >
                myra_quant_v2.2
              </option>
              <option
                className="bg-[#1a1c24] text-[#fafafa]"
                value="myra_macro_v3.0"
              >
                myra_macro_v3.0
              </option>
              <option
                className="bg-[#1a1c24] text-[#fafafa]"
                value="gemini_pro_v1.5"
              >
                gemini_pro_v1.5
              </option>
            </select>
          ...
          <div
            className="flex flex-col gap-1"
            title="Specify which internal SQLite database sidecar to query data from."
          >
            <label className="text-[10px] text-[#888] uppercase font-semibold">
              DB Route
            </label>
            <select
              value={dbRoute}
              onChange={(e) => setDbRoute(e.target.value)}
              className="bg-[#0e1117] border border-[#ffffff1a] text-[#ccc] text-xs p-1.5 rounded font-mono focus:outline-none focus:border-blue-500 transition-colors"
            >
              <option
                className="bg-[#1a1c24] text-[#fafafa]"
          ...
          <div
            className="flex flex-col gap-1"
            title="Tune for calculation speed vs processing precision."
          >
            <label className="text-[10px] text-[#888] uppercase font-semibold">
              Latency Opt
            </label>
            <select
              value={latencyOpt}
              onChange={(e) => setLatencyOpt(e.target.value)}
              className="bg-[#0e1117] border border-[#ffffff1a] text-[#ccc] text-xs p-1.5 rounded font-mono focus:outline-none focus:border-blue-500 transition-colors"
            >
              <option className="bg-[#1a1c24] text-[#fafafa]" value="lean">
                lean
              </option>
              <option className="bg-[#1a1c24] text-[#fafafa]" value="deep">
                deep
              </option>
              <option className="bg-[#1a1c24] text-[#fafafa]" value="balanced">
                balanced
              </option>
            </select>
          </div>
