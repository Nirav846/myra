                ...
                {isLoading ? (
                    ...
                    <div className="h-full overflow-y-auto">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tr>
                                <th className={`p-3 text-[12px] font-medium uppercase text-[#888] font-mono cursor-pointer hover:text-white transition-colors whitespace-nowrap ${sortConfig?.key === 'symbol' ? 'text-white' : ''}`} aria-sort={sortConfig?.key === 'symbol' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : 'none'} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleSort('symbol'); } }} onClick={() => handleSort('symbol')} scope="col">
                                    Symbol <SortIcon column="symbol" />
                                </th>
                                <th className={`p-3 text-[12px] font-medium uppercase text-[#888] font-mono cursor-pointer hover:text-white transition-colors whitespace-nowrap ${sortConfig?.key === 'sector' ? 'text-white' : ''}`} aria-sort={sortConfig?.key === 'sector' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : 'none'} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleSort('sector'); } }} onClick={() => handleSort('sector')} scope="col">
                                    Sector <SortIcon column="sector" />
                                </th>
                                <th className={`p-3 text-[12px] font-medium uppercase text-[#888] font-mono cursor-pointer hover:text-white transition-colors whitespace-nowrap ${sortConfig?.key === 'bucket' ? 'text-white' : ''}`} aria-sort={sortConfig?.key === 'bucket' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : 'none'} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleSort('bucket'); } }} onClick={() => handleSort('bucket')} scope="col">
                                    Bucket <SortIcon column="bucket" />
                                </th>
                                <th className={`p-3 text-[12px] font-medium uppercase text-[#888] font-mono cursor-pointer hover:text-white transition-colors whitespace-nowrap ${sortConfig?.key === 'bulkDeals' ? 'text-white' : ''}`} aria-sort={sortConfig?.key === 'bulkDeals' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : 'none'} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleSort('bulkDeals'); } }} onClick={() => handleSort('bulkDeals')} scope="col">
                                    Bulk Deals <SortIcon column="bulkDeals" />
                                </th>
                                <th className={`p-3 text-[12px] font-medium uppercase text-[#888] font-mono cursor-pointer hover:text-white transition-colors whitespace-nowrap ${sortConfig?.key === 'blockDeals' ? 'text-white' : ''}`} aria-sort={sortConfig?.key === 'blockDeals' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : 'none'} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleSort('blockDeals'); } }} onClick={() => handleSort('blockDeals')} scope="col">
                                    Block Deals <SortIcon column="blockDeals" />
                                </th>
                                <th className={`p-3 text-[12px] font-medium uppercase text-[#888] font-mono cursor-pointer hover:text-white transition-colors whitespace-nowrap ${sortConfig?.key === 'deliveryPct' ? 'text-white' : ''}`} aria-sort={sortConfig?.key === 'deliveryPct' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : 'none'} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleSort('deliveryPct'); } }} onClick={() => handleSort('deliveryPct')} scope="col">
                                    Delivery % <SortIcon column="deliveryPct" />
                                </th>
                                <th className={`p-3 text-[12px] font-medium uppercase text-[#888] font-mono cursor-pointer hover:text-white transition-colors whitespace-nowrap ${sortConfig?.key === 'score' ? 'text-white' : ''}`} aria-sort={sortConfig?.key === 'score' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : 'none'} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleSort('score'); } }} onClick={() => handleSort('score')} scope="col">
