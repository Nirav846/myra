...
export default function PositionSizer({ entryPrice, stopLossPrice, symbol }: PositionSizerProps) {
    ...
    return (
        <div className="bg-[#1a1c24] border border-[#ffffff1a] rounded p-3 mb-4">
            <div className="text-[12px] text-[#888] font-mono mb-2 flex items-center gap-1">
                <Calculator size={10} />
                Position Sizing — {symbol}
            </div>
            <div className="grid grid-cols-2 gap-3 mb-3">
                <div>
                    <label className="text-[12px] text-[#888] font-mono">
                        Account Size (₹)
                    </label>
                    <input
                        type="number"
            ...
            <div className="grid grid-cols-4 gap-2 text-center">
                ...
                <div className="bg-[#2a2c34] rounded p-2">
                    <div className="text-[12px] text-[#888] font-mono">Max Loss</div>
            ...
            {Number(positionPct) > 20 && (
                <div className="mt-2 text-[12px] text-red-400 font-mono flex items-center gap-1">
