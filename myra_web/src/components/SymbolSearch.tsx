...
export function SymbolSearch({
  ...
  initialValue = "",
  clearOnSelect = false,
}: SymbolSearchProps & { clearOnSelect?: boolean }) {
  ...
  return (
    <div className={`relative ${className}`} ref={wrapperRef}>
      ...
      />
      {loading && (
        <div className="absolute right-3 top-1/2 -translate-y-1/2 w-3 h-3 border-2 border-cyan-500 border-t-transparent rounded-full animate-spin"></div>
      )}
