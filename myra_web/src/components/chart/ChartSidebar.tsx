        ...
        <div className={`flex flex-col border-r border-[#ffffff1a] transition-all duration-300 ${sidebarOpen ? 'w-64' : 'w-0 overflow-hidden'}`}>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar bg-[#16181d]">
                <div className="space-y-3">
                    <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4 border-b border-white/5 pb-2">Candle Timeframe</h3>
                    <select 
                ...
                {Object.entries(toggles.reduce((acc, toggle) => {
                    ...
                    <div key={groupName} className="space-y-3 mb-6">
                        <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-4 border-b border-white/5 pb-2">{groupName}</h3>
                ...
                <div className="pt-4 border-t border-[#ffffff0a]">
                    <div className="p-3 bg-cyan-500/5 rounded-lg border border-cyan-500/10">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[10px] font-bold text-cyan-400 uppercase tracking-wider">Strategy Insight</span>
                        </div>
