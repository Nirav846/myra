...
class SymbolMapper:
    ...
    def __init__(
        self,
        csv_path=os.path.join(PROJECT_ROOT, "data", "symbol_change.csv"),
        manual_path=os.path.join(PROJECT_ROOT, "config", "manual_symbol_map.json"),
    ):
        ...
        if os.path.exists(csv_path):
            try:
                ...
                # Fix 28: Use itertuples for performance
