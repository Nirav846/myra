...
class PKDateUtilities:
    ...
    def holidayList():
        ...
        try:
            ...
            df['tradingDate'] = pd.to_datetime(df['tradingDate'], format='%d-%b-%Y').dt.strftime('%Y-%m-%d')
    ...
    def isHoliday(d1=None):
        ...
        if isinstance(d1, datetime.datetime):
            ...
            curr = datetime.datetime.combine(d1, datetime.time(0, 0)).replace(tzinfo=today_ist.tzinfo)
