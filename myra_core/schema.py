...
# ═══════════════════════════════════════════════════════════════
DELIVERY_COLS = ["delivery", "delivery_pct", "delivery_ratio", "delivery_qty", "delivery_source"]
...
SMC_COLS = [
    ...
    "fvg_top", "fvg_bottom", "fvg_boundary", "fvg_freshness",
    "swing_high", "swing_low", "liquidity_distance",
...
# ═══════════════════════════════════════════════════════════════
TECHNICAL_DATA_ALL = (
    CORE_COLS_DB + DELIVERY_COLS + ENRICHMENT_COLS + SMC_COLS + MA_COLS +
    ["trades", "vwap", "atr20", "atr5", "atr14", "atr_pct",
     "std20", "drawdown", "money_flow_cr"]
)
