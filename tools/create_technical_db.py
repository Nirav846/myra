...
def create_technical_db(db_path="technical.db"):
    ...
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_technical_symbol ON technical_data (symbol)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_technical_date ON technical_data (date)")
