...
try:
    ...
    df['delivery_divergence_score'] = ((df['delivery_pct']-rolling_mean)/rolling_std).fillna(0.0)*df['vcp']
    print('last delivery_divergence_score:', df['delivery_divergence_score'].iloc[-5:].tolist())
